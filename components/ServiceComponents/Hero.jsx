...
const Hero = () => {
  return (
    <div className='mt-40 px-2 lg:px-4 xl:px-10 2xl:px-32 flex flex-col lg:flex-row lg:space-x-5 2xl:space-x-32 items-center justify-center'>
        {/* pehla */}
        ...
        <input
            ...
            ></textarea>
              ...
              <div>
                <button className='bg-[#11A4FF] hover:bg-yellow-300 text-white w-[300px] lg:w-[300px] xl:w-[400px] text-xl py-3 rounded-lg'>Let's Get Started</button>
              </div>
        </form>
