...
const Thought = () => {
  return (
    <div  className='py-10 px-4 xl:px-20 2xl:px-40 bg-gradient-to-b from-[#11A4FF] to-[#062149] flex'>
        ...
        <p className='pt-5 text-white w-2/3'>Take the world by storm with a story that speaks volumes. Keep your reader's mind engaged with our wordplay. We are here to make your name – Your success is our satisfaction. Let your literary piece make waves</p>
        ...
        <div className='relative w-1/3 h-[200px] hidden lg:block'>
    <Image
